...
<div id="page-wrapper">
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Recent Orders
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <a href="www.php">View all orders</a>
            </div>
            <div class="panel-body">
                <div class="table-sorting table-responsive" id="subjectresult">
                    <table class="table table-striped table-bordered table-hover" id="tSortable22">
                        ...
                        FROM orders as o LEFT JOIN pay as p on o.pay_id=p.id ORDER BY o.date DESC LIMIT 10;";
                            ...
                            <a class='btn btn-info' href='xxx.php?order_id=" . $loopOrders['id'] . "&checkPayment=true'>Check For Payment</a></td>";
